...
When deploying Flycast using this Helm chart:
...
4. **Updates**
   ...
   - Monitor security advisories for the upstream [linuxserver/docker-flycast](https://github.com/linuxserver/docker-flycast) image.
