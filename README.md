# Flycast Helm Chart Repository

[![License](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Helm Version](https://img.shields.io/badge/Helm-v3-blue)](https://helm.sh)
[![Artifact Hub](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/flycast-helm-chart)](https://artifacthub.io/packages/search?repo=flycast-helm-chart)

This repository contains a production-ready Helm chart for deploying [Flycast](https://docs.linuxserver.io/images/docker-flycast/) on Kubernetes.

## About Flycast

Flycast is a free and open-source Sega Dreamcast, Naomi, Naomi 2, and Atomiswave emulator. This chart deploys the
[linuxserver.io](https://docs.linuxserver.io/images/docker-flycast/) build, which serves the full
emulator desktop in your browser over KasmVNC — no local install needed, play from any device on
your network:

- 🎮 Full Dreamcast/Naomi emulator desktop, streamed over the browser (KasmVNC)
...
- **[linuxserver.io Flycast Docs](https://docs.linuxserver.io/images/docker-flycast/)** - Upstream image documentation
...
Flycast itself is licensed under its own terms. See the [Flycast project](https://flycast.net/) and the
[linuxserver.io image](https://github.com/linuxserver/docker-flycast) for more information.

## Support

- 🐛 [Report Issues](https://github.com/HenriqZimer/flycast-helm-chart/issues)
- 💬 [Discussions](https://github.com/HenriqZimer/flycast-helm-chart/discussions)
